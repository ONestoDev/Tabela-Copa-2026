(function () {
  ...
  const KNOCKOUT_MATCHES = [
    ...
    {id:83, phase:'r32', label:'16 avos - 02 jul - 20:00 BRT', a:{type:'group', group:'H', pos:1}, b:{type:'group', group:'J', pos:2}},
    {id:84, phase:'r32', label:'16 avos - 02 jul - 16:00 BRT', a:{type:'group', group:'K', pos:2}, b:{type:'group', group:'L', pos:2}},
    {id:85, phase:'r32', label:'16 avos - 03 jul - 00:00 BRT', thirdHost:'B', a:{type:'group', group:'B', pos:1}, b:{type:'third', groups:['E','F','G','I','J']}},
    {id:86, phase:'r32', label:'16 avos - 03 jul - 19:00 BRT', a:{type:'group', group:'D', pos:2}, b:{type:'group', group:'G', pos:2}},
    {id:87, phase:'r32', label:'16 avos - 03 jul - 22:30 BRT', a:{type:'group', group:'J', pos:1}, b:{type:'group', group:'H', pos:2}},
    {id:88, phase:'r32', label:'16 avos - 03 jul - 15:00 BRT', thirdHost:'K', a:{type:'group', group:'K', pos:1}, b:{type:'third', groups:['D','E','I','J','L']}},
    {id:89, phase:'r16', label:'Oitavas - 04 jul - 18:00 BRT', a:{type:'winner', match:73}, b:{type:'winner', match:75}},
    {id:90, phase:'r16', label:'Oitavas - 04 jul - 14:00 BRT', a:{type:'winner', match:74}, b:{type:'winner', match:77}},
    ...
    {id:93, phase:'r16', label:'Oitavas - 06 jul - 16:00 BRT', a:{type:'winner', match:81}, b:{type:'winner', match:82}},
    {id:94, phase:'r16', label:'Oitavas - 06 jul - 21:00 BRT', a:{type:'winner', match:83}, b:{type:'winner', match:84}},
    {id:95, phase:'r16', label:'Oitavas - 07 jul - 13:00 BRT', a:{type:'winner', match:85}, b:{type:'winner', match:87}},
    {id:96, phase:'r16', label:'Oitavas - 07 jul - 17:00 BRT', a:{type:'winner', match:86}, b:{type:'winner', match:88}},
